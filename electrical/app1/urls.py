...
urlpatterns = [
    ...
    path('latest-product/', mostselledproductlist.as_view({'get': 'list'}), name="latest_product"),
    path('latest-product/<int:pk>/', latestproductdetail.as_view(), name="latestdetail_product"),
    path('mostselled-product/', latestproductlist.as_view({'get': 'list'}), name="mostselled_product"),
